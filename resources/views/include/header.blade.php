    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <div class="top-menu d-flex align-items-center">
                ...
                <button type="button" style="display:none" class="nav-link ml-10 right-sidebar-toggle"><i class="ik ik-message-square"></i><span class="badge bg-success">3</span></button>
                <div class="dropdown" style="display: none">
